"""
Script to create GitHub issues for all 150 NeetCode 150 LeetCode problems.
...
Requires:
    ...
    - GITHUB_REPOSITORY environment variable (e.g., "cd155/neetcode-150-python-template")
...
LIST_LABEL = "neetcode-150"
EXPECTED_PROBLEMS = 150
